        ...
        <div style={{backgroundImage: `url( ${bkgrd} )`, backgroundSize: 'cover'}}>
            ...
            <div className="container-fluid" style={{marginTop: '7vh'}}>
                <div className="row">
                    ...
                    <p className="inforeadinner">Polygon is a Layer 2 on the Ethereum blockchain. You can access it by adding the Polygon network to your Metamask wallet. “Polygon believes in Web3 for all. Polygon is a decentralized Ethereum scaling platform that enables developers to build scalable user-friendly dApps with low transaction fees without ever sacrificing on security.” Learn more about Polygon at <a href="https://polygon.technology/">https://polygon.technology/</a></p>
                    ...
                    <p className="inforeadinner">Follow the steps in this article: <a href="https://docs.polygon.technology/docs/develop/metamask/config-polygon-on-metamask/">Add Polygon Network</a></p>
                    ...
                    <p className="inforeadinner mb-0">Polygon(MATIC) is the primary cryptocurrency of the Polygon network and is the token we will be using for our game. This means you will need to acquire MATIC.
                        The absolute easiest way is to buy ETH, navigate to Opensea, click on the wallet icon and bridge MATIC over to Polygon directly. Explained <a href="https://support.opensea.io/hc/en-us/articles/1500012881642-How-do-I-transfer-ETH-from-Ethereum-to-Polygon-">Here.</a></p>
                    <p className="inforeadinner mb-0">Another easy way is to navigate to the <a href="https://wallet.polygon.technology/bridge/">Polygon bridge</a> and bridge your ETH over. </p>
                    <p className="inforeadinner mb-0">Once your ETH has been bridged over, you’ll want to swap it for MATIC at a trusted exchange such as <a href="https://sushi.com/">Sushiswap.</a></p>
